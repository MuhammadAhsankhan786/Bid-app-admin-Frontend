                              ...
                              {product.image_url || product.image ? (
                                <ImageWithFallback 
                                  ...
                                  onError={(e) => {
                                    ...
                                    if (parent) {
                                      const fallbackSvg = "<div class=\"w-full h-full flex items-center justify-center\"><svg class=\"w-6 h-6 text-gray-400\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z\"></path></svg></div>";
                ...
                {selectedProduct.image_url || selectedProduct.image ? (
                  <ImageWithFallback 
                    ...
                    onError={(e) => {
                      ...
                      const parent = e.currentTarget.parentElement;
                      if (parent) {
                        const fallbackSvg = "<div class=\"w-full h-full flex items-center justify-center\"><svg class=\"w-16 h-16 text-gray-400\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z\"></path></svg></div>";
                        parent.innerHTML = fallbackSvg;
                      }
                    }}
                  />
